...
class IntensiveReader(BaseReader):
    ...
    def compute_predictions(
        ...
        for example_index, example in enumerate(tqdm(examples)):
            ...
            predictions = sorted(prelim_predictions, key=lambda x: x["score"], reverse=True)[:n_best_size-1]
...
class RearVerifier:
    ...
    def __call__(
        ...
        return output_predictions, output_scores, highest_prob
...
class RetroReader:
    ...
    def load(
        ...
        # sketch_tokenizer = BertTokenizer(
        #     vocab_file="./configs/sketch/vocab.txt",
        #     do_lower_case=True
        # )
        ...
        # intensive_tokenizer = BertTokenizer(
        #     vocab_file="./configs/intensive/vocab.txt",
        #     do_lower_case=True
        # )
    ...
    def __call__(
        ...
        return self.inference(predict_examples, query, context, return_submodule_outputs)
    ...
    def inference(self, test_dataset: datasets.Dataset, query: str,
        context: Union[str, List[str]], return_submodule_outputs: bool = False) -> Tuple[Any]:
